...
<header>
    <nav class="navbar navbar-dark bg-dark">
        <li class="nav-item dropdown" style="list-style-type: none;">
            <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown">Soluciones</a>
        ...
        <li class="nav-item dropdown" style="list-style-type: none;">
            <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown">Somos</a>
        ...
        <li class="nav-item dropdown" style="list-style-type: none;">
            <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown">Sectores</a>
        ...
        <li class="nav-item dropdown" style="list-style-type: none;">
            <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown">Talento</a>
